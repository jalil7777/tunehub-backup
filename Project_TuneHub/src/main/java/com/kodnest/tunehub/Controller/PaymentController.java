...
public class PaymentController {
	...
	public String createOrder(HttpSession session) {
		...
		Order order=null;
		try {
			RazorpayClient razorpay=new RazorpayClient("rzp_test_xKyBc1H5VLfT9v", "vc28pL71vEZmJmfaBKLEWzpJ");
...
//			userService.updateUser(user);
		//	rzp_test_xKyBc1H5VLfT9v
		//	vc28pL71vEZmJmfaBKLEWzpJ
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
	    ...
	    try {
	        ...
	        RazorpayClient razorpayClient = new RazorpayClient("rzp_test_xKyBc1H5VLfT9v", 
	        								"vc28pL71vEZmJmfaBKLEWzpJ");
